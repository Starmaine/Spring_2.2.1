...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.add(new User("User2", "Lastname2", "user2@mail.ru", new Car("BMV", 2)));
      userService.add(new User("User3", "Lastname3", "user3@mail.ru", new Car("Mercedes", 180)));
      userService.add(new User("User4", "Lastname4", "user4@mail.ru", new Car("ZEEKR", 5)));
      ...
      List<User> userCar = userService.getByModel("ZEEKR", 5);
